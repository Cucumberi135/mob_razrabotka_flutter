...
class MyApp extends StatelessWidget {
  ...
  Widget headerTop() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        SizedBox(height: 100, width: 100, child: CircleAvatar(radius:20)),
        SizedBox(height: 50, width: 200,// color: Colors.yellow,
  ...
  Widget header() {
    return Container(
      ...
      image: NetworkImage('https://pbs.twimg.com/media/GgbweBvXYAArE5y.jpg'),
      fit: BoxFit.cover)),
